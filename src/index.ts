 ...
 *   仕組みの動きは 1 つも変わっていない。
 *   理由：Google の許可が 7 日で切れていたのは、同意画面が「テスト中」のままだったため
 *   （2026-08-28 に Google の説明で確認）。「本番」へ移すには同意画面の
 *   ホームページ・プライバシー ポリシー・利用規約の 3 つの住所が要り、
 *   その住所は承認済みドメイン（gameister1.workers.dev）の下でなければならない。
 *   置き場を新しく作らず、この Worker に 2 つ足すのがいちばん short い道だった。
 *
...
/**
 * Google の同意画面に載せる住所として要るだけのもの。
 * 外部に配るアプリではなく、Naoki 本人しか使わないので、書いてあることも実態そのまま。
 */
const PRIVACY_TEXT = [
  "zoom-to-youtube プライバシーポリシー",
  "最終更新日：2026-08-28",
  "",
  "1. このアプリについて",
  "  株式会社 BestLifeConsulting が自社の運用のために作った道具です。",
  "  一般に配布しておらず、利用者は運営者本人だけです。",
  "",
  "2. 扱う情報",
  "  ・Google ドライブ：このアプリが作ったフォルダとファイルだけ（drive.file）",
  "  ・Google スプレッドシート：このアプリが作った管理用シートだけ",
  "  ・YouTube：動画の投稿と、チャンネルの本数の読み取り",
  "  ・Google アカウントのメールアドレス（どのアカウントで許可したかの表示のため）",
  "  ・Zoom の録画（動画・文字起こし）",
  "",
  "3. 使い道",
  "  Zoom の録画を Google ドライブへ保存し、YouTube へ限定公開で上げること。",
  "  それ以外の用途には使いません。",
  "",
  "4. 保存する場所と期間",
  "  Google の許可の控えと処理の途中経過を、Cloudflare R2 に保存します。",
  "  許可を取り消すと使えなくなります。不要になった時点で消します。",
  "",
  "5. 外部へ渡すこと",
  "  第三者へ売ったり渡したりしません。広告にも使いません。",
  "  通信先は Google と Zoom と Cloudflare だけです。",
  "",
  "6. 許可の取り消し",
...
const TERMS_TEXT = [
  "zoom-to-youtube 利用規約",
  "最終更新日：2026-08-28",
  "",
  "1. 適用",
  "  この規約は、株式会社 BestLifeConsulting が運用する zoom-to-youtube に適用します。",
  "",
  "2. 使える人",
  "  運営者が許可したアカウントだけです。一般には公開していません。",
  "",
  "3. できること",
  "  Zoom の録画を Google ドライブへ保存し、YouTube へ上げることだけです。",
  "",
  "4. してはいけないこと",
  "  ・権利を持たない録画を通すこと",
  "  ・法令に反する使い方",
  ...
  "",
  "5. 止めること・変えること",
  "  予告なく内容を変えたり、提供を止めたりすることがあります。",
  "",
  "6. 責任の範囲",
  "  自社の運用のための道具であり、使ったことで生じた損害について責任を負いません。",
  "",
  "7. 問い合わせ先",
  "  gameister1@gmail.com",
].join("\n");
